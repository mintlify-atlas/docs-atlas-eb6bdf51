...
<ParamField path="agents" type="dict[str, AgentEntry]" default="{}">
  Dictionary mapping agent names to their `AgentEntry` objects
</ParamField>

<ParamField path="tools" type="dict[str, ToolEntry]" default="{}">
  Dictionary mapping tool names to their `ToolEntry` objects
</ParamField>

<ParamField path="config" type="dict[str, Any]" default="{}">
